# App Specification: Centro — Centralized Social Media Control Hub

> Working title "Centro" — rename freely. This spec is written to be handed to an AI coding agent. It is deliberately explicit about architecture, failure modes, and where files go.
