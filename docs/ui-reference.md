...
This file contains the original HTML/CSS produced by Google Stitch for the six Centro screens. It is **reference only** — the real implementation uses Next.js 14, React, TypeScript, shadcn/ui, and Tailwind CSS.

## App Name

The original Stitch output used the working title **OmniPost**. The project name is **Centro**. All labels, headings, and metadata in the implementation should use Centro.
...
| Stitch Element | Centro Component |
|---|---|
